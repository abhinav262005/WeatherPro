-- ============================================
-- WeatherPro Database Schema - COMPLETE VERSION
-- Complete Database Setup with Admin Support & User Settings Persistence
-- ============================================
...
-- ============================================
-- User Preferences Table (with Dashboard Customization)
-- ============================================
...
--   All dashboard customization settings (theme, colors, card style, etc.)
--   are now saved to the user_preferences table and will persist across
